...
def main(argv):
	...
	command = "/root/code/config" + " " + "--username " + username + " --password " + username + " --tenant "+ username + " --api-server 127.0.0.1 " + "add network public-" + username + "-net " + "--ipam ipam-default --subnet " + subnet + " --route-target " + target
